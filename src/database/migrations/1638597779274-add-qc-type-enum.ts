...
export class addQcTypeEnum1638597779274 implements MigrationInterface {
    name = 'addQcTypeEnum1638597779274'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TYPE "public"."error_reports_report_type_enum" AS ENUM('0', '1', '2', '3')`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TYPE "public"."error_reports_report_type_enum_old" AS ENUM('0', '1', '2')`);
